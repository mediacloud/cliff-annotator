    ...
    protected List<List<ResolvedLocation>> disambiguate(
        ...
        for( List<ResolvedLocation> candidates: possibilitiesToDo){
            ...
            if(exactMatches.size()>0){
                ...
                if(cityCandidate!=null) logger.debug("    city "+cityCandidate.geoname.geonameID);
                if(adminCandidate!=null) logger.debug("    admin "+adminCandidate.geoname.geonameID);
                ...
                logger.debug("    city "+cityCandidate.geoname.geonameID);
                logger.debug("    admin "+adminCandidate.geoname.geonameID);
