 ...
 * @author rahulb
 */
public class ParseNlpJsonRequestHandler implements HttpHandler {

    private static final Logger logger = LoggerFactory.getLogger(ParseNlpJsonRequestHandler.class);
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        if (requestMethod.equalsIgnoreCase("GET")) {
            ...
            try {
                ...
                results = ParseManager.parseFromNlpJson(input);
                logger.info(results);
